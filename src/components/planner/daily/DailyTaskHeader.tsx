...
const DailyTaskHeader: React.FC<DailyTaskHeaderProps> = ({
  ...
  return <div className="flex items-center justify-between mb-4 my-0 px-px mx-0 py-[3px]">
      ...
      <div className="flex items-center absolute left-1/2 transform -translate-x-1/2 text-white">
        <div className="flex flex-col items-center">
          <button onClick={openCalendarModal} className="flex items-center gap-2 text-2xl font-bold transition-colors">
