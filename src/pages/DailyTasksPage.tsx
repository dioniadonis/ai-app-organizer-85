      ...
      <div className={`mx-auto p-2 ${isMobile ? 'max-w-md' : 'max-w-2xl'}`}>
                  ...
                  <div className="flex-1 ml-4">
                    {tasksInSlot.length > 0 ? (
                      ...
                      <button
                        ...
                        className="w-full p-2 rounded-md border border-dashed border-gray-700 hover:border-gray-500 hover:bg-gray-800/20 transition-colors text-center"
                      >
                        <Plus size={16} className="inline-block text-gray-400 mr-1" />
        ...
        <Dialog open={showAddModal} onOpenChange={setShowAddModal}>
          <DialogContent className="bg-gray-900 border-gray-800">
            <DialogHeader>
              <DialogTitle className="text-white">{selectedTask ? 'Edit Task' : 'Add New Task'}</DialogTitle>
            </DialogHeader>
            ...
            <DialogFooter>
              <Button onClick={() => setShowAddModal(false)} variant="outline" className="bg-transparent text-white border-gray-600">
                Cancel
              </Button>
              <Button 
        ...
        <Dialog open={showSettingsModal} onOpenChange={setShowSettingsModal}>
          <DialogContent className="bg-gray-900 border-gray-800">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm text-gray-400">Time Increment</label>
                <select 
                  value={timeIncrement} 
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <label className="text-sm text-gray-300">Show Warning Before Clearing Tasks</label>
                  <p className="text-xs text-gray-400">Displays a confirmation dialog before clearing tasks</p>
                </div>
                <Switch 
        ...
        <Dialog open={showCopyModal} onOpenChange={setShowCopyModal}>
          <DialogContent className="bg-gray-900 border-gray-800">
            <DialogHeader>
              <DialogTitle className="text-white">Copy Tasks To Date</DialogTitle>
            ...
            <DialogFooter>
              <Button onClick={() => setShowCopyModal(false)} variant="outline" className="bg-transparent text-white border-gray-600">
                Cancel
              </Button>
              <Button 
        ...
        <Dialog open={showMoveTaskModal} onOpenChange={setShowMoveTaskModal}>
          <DialogContent className="bg-gray-900 border-gray-800">
            <DialogHeader>
              <DialogTitle className="text-white">Move Task To Date</DialogTitle>
              <DialogDescription className="text-gray-400">
                {selectedTask ? `Move "${selectedTask.name}" to another date` : 'Move task to another date'}
              </DialogDescription>
            </DialogHeader>
            <div className="flex flex-col gap-4">
              <div>
            ...
            <DialogFooter>
              <Button onClick={() => setShowMoveTaskModal(false)} variant="outline" className="bg-transparent text-white border-gray-600">
                Cancel
              </Button>
              <Button 
        ...
        <Dialog open={showCategoryModal} onOpenChange={setShowCategoryModal}>
          <DialogContent className="bg-gray-900 border-gray-800">
            <DialogHeader>
              <DialogTitle className="text-white">Edit Category & Color</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              <div>
                <label className="text-sm text-gray-400">Category</label>
            ...
            <DialogFooter>
              <Button onClick={() => setShowCategoryModal(false)} variant="outline" className="bg-transparent text-white border-gray-600">
                Cancel
              </Button>
              <Button 
        ...
        {/* Confirm clear tasks modal */}
        <Dialog open={showClearTasksModal} onOpenChange={setShowClearTasksModal}>
          <DialogContent className="bg-gray-900 border-gray-800">
            <DialogHeader>
              <DialogTitle className="text-white">Clear Tasks</DialogTitle>
              <DialogDescription className="text-gray-400">
            ...
            <div className="flex items-center space-x-2 mt-2">
              ...
              />
              <Label htmlFor="disable-warning" className="text-sm text-gray-400">Don't show this warning again</Label>
            </div>
            <DialogFooter>
              <Button onClick={() => setShowClearTasksModal(false)} variant="outline" className="bg-transparent text-white border-gray-600">
                Cancel
              </Button>
              <Button 
